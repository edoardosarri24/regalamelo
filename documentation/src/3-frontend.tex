...
\begin{itemize}
    ...
    \item \textbf{Dynamic SEO with React Helmet Async} \\
        Since React applications do not reload the page on navigation, dynamic metadata injection is required. \texttt{react-helmet-async} is utilized to dynamically update the \texttt{<title>}, \texttt{<meta name="description">}, and other relevant tags based on the current component (e.g., setting the title to a specific list's name: "Marco's Gift List | Compralo").
